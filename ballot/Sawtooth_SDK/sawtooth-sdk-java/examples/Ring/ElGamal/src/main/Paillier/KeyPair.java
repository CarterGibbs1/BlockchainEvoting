...
public class KeyPair {
    ...
    public final BigInteger decryptBase16(BigInteger c) {

        BigInteger n = new BigInteger(publicKey.getN().toString(), 16);
        BigInteger nSquare = new BigInteger(publicKey.getnSquared().toString(), 16);
        BigInteger lambda = new BigInteger(privateKey.getLambda().toString(), 16);

        BigInteger u = new BigInteger(privateKey.getPreCalculatedDenominator().toString(), 16);
